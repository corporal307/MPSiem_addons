...
def send_telegram_message(inc, settings):
    ...
    requests.post("https://api.telegram.org/bot" + settings['token'] + "/sendMessage",
                  data={'chat_id': settings['chat_id'], 'text': msg, 'parse_mode': 'Markdown'})
...
if __name__ == "__main__":
    ...
    settings['core_url'] = ''  # https://maxpatrolsiemaddress
